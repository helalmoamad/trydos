...
void main() {
  ...
  testWidgets('Test search for product in boutique', (
    WidgetTester tester,
  ) async {
    ...
    final boutiqueId1 = tester
        .widget<HomePageBoutiqueCard>(boutiqueCard1)
        .boutique
        .id!;
    ...
    await GlobalTestFunctions.waitFor(tester, productsList);
    ...
    const productKey = Key('${WidgetsKeys.productInBoutiqueListKey}0');
    ...
    final Finder productListingSearchIcon = find.byKey(
      const Key(WidgetsKeys.productListingSearchIconKey),
    );
