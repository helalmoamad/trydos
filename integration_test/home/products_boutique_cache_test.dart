...
void main() {
  ...
  Future<void> noLoadingTest({
    ...
    // ///////////  no loading  /////////
    Finder boutiqueProductListingLoadingWidget = find.byKey(
    ...
    Finder productListFilterWidget = find.byKey(
  ...
  testWidgets('Test product list cache in boutique', (
    WidgetTester tester,
  ) async {
    app.main();
    ...
    ////////////////////////////
    final boutiqueId2 = tester
        .widget<HomePageBoutiqueCard>(boutiqueCard2)
        .boutique
        .id!;
    ////////////////////////////
