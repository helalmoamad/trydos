...
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i37;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i43;
...
import '../../features/story/domain/useCases/get_stories_usecase.dart' as _i44;
import '../../features/story/domain/useCases/get_width_and_height_usecase.dart'
    as _i45;
import '../../features/story/presentation/bloc/story_bloc.dart' as _i46;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i37.UploadFileUseCase>(
      () => _i37.UploadFileUseCase(gh<_i9.ChatRepository>()));
  gh.factory<_i38.VerifyGuestPhoneUseCase>(
      () => _i38.VerifyGuestPhoneUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i39.VerifyOtpSignInUseCase>(
      () => _i39.VerifyOtpSignInUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i40.VerifyOtpSignUpUseCase>(
      () => _i40.VerifyOtpSignUpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i41.AuthBloc>(() => _i41.AuthBloc(
        ...
        gh<_i38.VerifyGuestPhoneUseCase>(),
        gh<_i39.VerifyOtpSignInUseCase>(),
        gh<_i40.VerifyOtpSignUpUseCase>(),
      ));
  gh.factory<_i42.ChangeChatPropertyUseCase>(
      () => _i42.ChangeChatPropertyUseCase(gh<_i9.ChatRepository>()));
  gh.lazySingleton<_i43.ChatBloc>(() => _i43.ChatBloc(
        ...
        gh<_i37.UploadFileUseCase>(),
        gh<_i16.GetMessagesForChatUseCase>(),
        gh<_i12.DeleteChatUseCase>(),
        gh<_i42.ChangeChatPropertyUseCase>(),
  ...
  gh.factory<_i44.GetStoryUseCase>(
      () => _i44.GetStoryUseCase(gh<_i35.StoryRepository>()));
  gh.factory<_i45.GetWidthAndHeightUseCase>(
      () => _i45.GetWidthAndHeightUseCase(gh<_i35.StoryRepository>()));
  gh.lazySingleton<_i46.StoryBloc>(() => _i46.StoryBloc(
        gh<_i44.GetStoryUseCase>(),
        gh<_i45.GetWidthAndHeightUseCase>(),
      ));
  return getIt;
}
