...
import '../../features/calls/data/repositories/calls_repository_impl.dart'
    as _i58;
import '../../features/calls/domain/repositories/calls_repository.dart' as _i57;
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i79;
import '../../features/calls/domain/useCase/delete_Message.dart' as _i80;
import '../../features/calls/domain/useCase/get_agora_token_use_case.dart'
    as _i81;
import '../../features/calls/domain/useCase/get_missed_call_count.dart' as _i82;
import '../../features/calls/domain/useCase/get_my_calls.dart' as _i83;
import '../../features/calls/domain/useCase/make_call_usecase.dart' as _i84;
import '../../features/calls/domain/useCase/reject_call_usecase.dart' as _i85;
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i86;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i89;
import '../../features/chat/data/data_sources/chat_remote_datasource.dart'
    as _i8;
import '../../features/chat/data/repositories/chat_repository_impl.dart'
    as _i60;
import '../../features/chat/domain/repositories/chat_repository.dart' as _i59;
import '../../features/chat/domain/use_cases/change_chat_property_usecase.dart'
    as _i64;
import '../../features/chat/domain/use_cases/delete_chat_usecase.dart' as _i65;
import '../../features/chat/domain/use_cases/get_contacts_usecase.dart' as _i66;
import '../../features/chat/domain/use_cases/get_date_time.dart' as _i67;
...
import '../../features/chat/domain/use_cases/get_messages_for_chat_usecase.dart'
    as _i71;
import '../../features/chat/domain/use_cases/get_my_chats_usecase.dart' as _i72;
...
import '../../features/chat/domain/use_cases/send_error_to_server_usecase.dart'
    as _i76;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i77;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i78;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i88;
...
import '../../features/home/domain/use_cases/remove_item_from_cart_usecase.dart'
    as _i54;
import '../../features/home/presentation/manager/home_bloc.dart' as _i62;
...
import '../../features/story/presentation/bloc/story_bloc.dart' as _i87;
import '../data/data_source/common_use_repo_data_source.dart' as _i3;
import '../data/repository/common_use_repository_impl.dart' as _i56;
import '../domin/repositories/common_use_repository.dart' as _i55;
import '../domin/repositories/prefs_repository.dart' as _i14;
import '../domin/usecases/upload_file_cloudinary_usecase.dart' as _i61;
import 'di_container.dart' as _i91;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i52.AddItemToCartUseCase>(
      () => _i52.AddItemToCartUseCase(gh<_i19.HomeRepository>()));
  ...
  gh.lazySingleton<_i55.CommonUseRepository>(
      () => _i56.CommonUseRepositoryImpl(gh<_i3.CommonUseRemoteDataSource>()));
  gh.lazySingleton<_i57.CallsRepository>(
      () => _i58.CallsRepositoryImpl(gh<_i7.CallsRemoteDataSource>()));
  gh.lazySingleton<_i59.ChatRepository>(
      () => _i60.ChatRepositoryImpl(gh<_i8.ChatRemoteDataSource>()));
  gh.factory<_i61.UploadFileCloudinaryUseCase>(
      () => _i61.UploadFileCloudinaryUseCase(gh<_i55.CommonUseRepository>()));
  ...
  gh.factory<_i63.CreateUserUseCase>(
      () => _i63.CreateUserUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i64.ChangeChatPropertyUseCase>(
      () => _i64.ChangeChatPropertyUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i65.DeleteChatUseCase>(
      () => _i65.DeleteChatUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i66.GetContactsUseCase>(
      () => _i66.GetContactsUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i67.GetDateTimeUseCase>(
      () => _i67.GetDateTimeUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i68.GetWidthAndHeightUseCase>(
      () => _i68.GetWidthAndHeightUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i69.GetMediaCountUseCase>(
      () => _i69.GetMediaCountUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i70.GetMessagesBetweenUseCase>(
      () => _i70.GetMessagesBetweenUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i71.GetMessagesForChatUseCase>(
      () => _i71.GetMessagesForChatUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i72.GetMyChatsUseCase>(
      () => _i72.GetMyChatsUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i73.ReadAllMessagesUseCase>(
      () => _i73.ReadAllMessagesUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i74.ReceiveMessageUseCase>(
      () => _i74.ReceiveMessageUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i75.SaveContactsUseCase>(
      () => _i75.SaveContactsUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i76.SendErrorToServerUseCase>(
      () => _i76.SendErrorToServerUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i77.SendMessageUseCase>(
      () => _i77.SendMessageUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i78.UploadFileUseCase>(
      () => _i78.UploadFileUseCase(gh<_i59.ChatRepository>()));
  gh.factory<_i79.AnswerCallUseCase>(
      () => _i79.AnswerCallUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i80.DeleteMessageUseCase>(
      () => _i80.DeleteMessageUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i81.GetAgoraTokenUseCase>(
      () => _i81.GetAgoraTokenUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i82.GetMissedCalCountUseCase>(
      () => _i82.GetMissedCalCountUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i83.GetMyCallsUseCase>(
      () => _i83.GetMyCallsUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i84.MakeCallUseCase>(
      () => _i84.MakeCallUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i85.RejectCallUseCase>(
      () => _i85.RejectCallUseCase(gh<_i57.CallsRepository>()));
  gh.factory<_i86.WatchMissedCallUseCase>(
      () => _i86.WatchMissedCallUseCase(gh<_i57.CallsRepository>()));
  gh.lazySingleton<_i87.StoryBloc>(() => _i87.StoryBloc(
        gh<_i61.UploadFileCloudinaryUseCase>(),
  ...
  gh.lazySingleton<_i88.ChatBloc>(() => _i88.ChatBloc(
        gh<_i66.GetContactsUseCase>(),
        gh<_i72.GetMyChatsUseCase>(),
        gh<_i75.SaveContactsUseCase>(),
        gh<_i77.SendMessageUseCase>(),
        gh<_i70.GetMessagesBetweenUseCase>(),
        gh<_i61.UploadFileCloudinaryUseCase>(),
        gh<_i71.GetMessagesForChatUseCase>(),
        gh<_i65.DeleteChatUseCase>(),
        gh<_i64.ChangeChatPropertyUseCase>(),
        gh<_i78.UploadFileUseCase>(),
        gh<_i73.ReadAllMessagesUseCase>(),
        gh<_i74.ReceiveMessageUseCase>(),
        gh<_i69.GetMediaCountUseCase>(),
        gh<_i67.GetDateTimeUseCase>(),
        gh<_i76.SendErrorToServerUseCase>(),
      ));
  gh.lazySingleton<_i89.CallsBloc>(() => _i89.CallsBloc(
        gh<_i85.RejectCallUseCase>(),
        gh<_i84.MakeCallUseCase>(),
        gh<_i83.GetMyCallsUseCase>(),
        gh<_i86.WatchMissedCallUseCase>(),
        gh<_i79.AnswerCallUseCase>(),
        gh<_i82.GetMissedCalCountUseCase>(),
        gh<_i81.GetAgoraTokenUseCase>(),
        gh<_i80.DeleteMessageUseCase>(),
      ));
  gh.lazySingleton<_i90.AuthBloc>(() => _i90.AuthBloc(
        gh<_i39.UpdateStoriesUserUseCase>(),
        gh<_i37.UpdateChatUserNameUseCase>(),
        gh<_i63.CreateUserUseCase>(),
...
class _$AppModule extends _i91.AppModule {}
