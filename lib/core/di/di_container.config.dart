...
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i66;
...
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i64;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i68;
...
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i59;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i70;
...
import '../../features/home/domain/use_cases/get_main_categories_usecase.dart'
    as _i72;
import '../../features/home/domain/use_cases/get_products_usecase.dart' as _i73;
...
import '../../features/story/domain/useCases/add_story_to_our_server_usecase.dart'
    as _i65;
import '../../features/story/domain/useCases/get_stories_usecase.dart' as _i75;
...
import '../../features/story/domain/useCases/increase_viewers_usecase.dart'
    as _i78;
import '../../features/story/domain/useCases/upload_story_usecase.dart' as _i60;
...
import 'di_container.dart' as _i80;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i55.UpdateChatUserNameUseCase>(
      () => _i55.UpdateChatUserNameUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i56.UpdateNameUseCase>(
      () => _i56.UpdateNameUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i57.UpdateStoriesUserUseCase>(
      () => _i57.UpdateStoriesUserUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i58.UploadFileCloudinaryUseCase>(
      () => _i58.UploadFileCloudinaryUseCase(gh<_i15.CommonUseRepository>()));
  gh.factory<_i59.UploadFileUseCase>(
      () => _i59.UploadFileUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i60.UploadStoryUseCase>(
      () => _i60.UploadStoryUseCase(gh<_i53.StoryRepository>()));
  gh.factory<_i61.VerifyGuestPhoneUseCase>(
      () => _i61.VerifyGuestPhoneUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i62.VerifyOtpSignInUseCase>(
      () => _i62.VerifyOtpSignInUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i63.VerifyOtpSignUpUseCase>(
      () => _i63.VerifyOtpSignUpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i64.WatchMissedCallUseCase>(
      () => _i64.WatchMissedCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i65.AddStoryToOurServerUseCase>(
      () => _i65.AddStoryToOurServerUseCase(gh<_i53.StoryRepository>()));
  gh.factory<_i66.AnswerCallUseCase>(
      () => _i66.AnswerCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i67.AuthBloc>(() => _i67.AuthBloc(
        gh<_i57.UpdateStoriesUserUseCase>(),
        gh<_i55.UpdateChatUserNameUseCase>(),
        ...
        gh<_i56.UpdateNameUseCase>(),
        gh<_i44.RegisterGuestUseCase>(),
        gh<_i48.SendOtpUseCase>(),
        gh<_i23.GetCustomerInfoUseCase>(),
        gh<_i61.VerifyGuestPhoneUseCase>(),
        gh<_i62.VerifyOtpSignInUseCase>(),
        gh<_i30.GetUserCountryUseCase>(),
        gh<_i63.VerifyOtpSignUpUseCase>(),
      ));
  gh.lazySingleton<_i68.CallsBloc>(() => _i68.CallsBloc(
        gh<_i45.RejectCallUseCase>(),
        gh<_i39.MakeCallUseCase>(),
        gh<_i28.GetMyCallsUseCase>(),
        gh<_i64.WatchMissedCallUseCase>(),
        gh<_i66.AnswerCallUseCase>(),
  ...
  gh.factory<_i69.ChangeChatPropertyUseCase>(
      () => _i69.ChangeChatPropertyUseCase(gh<_i12.ChatRepository>()));
  gh.lazySingleton<_i70.ChatBloc>(() => _i70.ChatBloc(
  ...
  gh.factory<_i71.GetHomeSectionsUseCase>(
      () => _i71.GetHomeSectionsUseCase(gh<_i33.HomeRepository>()));
  gh.factory<_i72.GetMainCategoriesUseCase>(
      () => _i72.GetMainCategoriesUseCase(gh<_i33.HomeRepository>()));
  gh.factory<_i73.GetProductsWithoutFiltersUseCase>(
      () => _i73.GetProductsWithoutFiltersUseCase(gh<_i33.HomeRepository>()));
  gh.factory<_i74.GetStartingSettingsUseCase>(
      () => _i74.GetStartingSettingsUseCase(gh<_i33.HomeRepository>()));
  gh.factory<_i75.GetStoryUseCase>(
      () => _i75.GetStoryUseCase(gh<_i53.StoryRepository>()));
  gh.factory<_i76.GetWidthAndHeightUseCase>(
      () => _i76.GetWidthAndHeightUseCase(gh<_i53.StoryRepository>()));
  gh.lazySingleton<_i77.HomeBloc>(() => _i77.HomeBloc(
        gh<_i71.GetHomeSectionsUseCase>(),
        gh<_i72.GetMainCategoriesUseCase>(),
        gh<_i74.GetStartingSettingsUseCase>(),
        gh<_i73.GetProductsWithoutFiltersUseCase>(),
      ));
  gh.factory<_i78.IncreaseViewersUseCase>(
      () => _i78.IncreaseViewersUseCase(gh<_i53.StoryRepository>()));
  gh.lazySingleton<_i79.StoryBloc>(() => _i79.StoryBloc(
        gh<_i58.UploadFileCloudinaryUseCase>(),
        gh<_i75.GetStoryUseCase>(),
        gh<_i76.GetWidthAndHeightUseCase>(),
        gh<_i60.UploadStoryUseCase>(),
        gh<_i78.IncreaseViewersUseCase>(),
        gh<_i65.AddStoryToOurServerUseCase>(),
      ));
  return getIt;
}
