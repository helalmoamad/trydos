...
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i59;
import '../../features/calls/domain/useCase/get_agora_token_use_case.dart'
    as _i20;
import '../../features/calls/domain/useCase/reject_call_usecase.dart' as _i40;
import '../../features/calls/domain/useCase/video_call_usecase.dart' as _i57;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i61;
...
import '../../features/chat/domain/use_cases/save_contacts_usecase.dart'
    as _i41;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i42;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i52;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i63;
...
import '../../features/home/domain/use_cases/get_main_categories_usecase.dart'
    as _i65;
import '../../features/home/domain/use_cases/get_products_usecase.dart' as _i66;
import '../../features/home/domain/use_cases/get_starting_settings_usecase.dart'
    as _i67;
import '../../features/home/presentation/manager/home_bloc.dart' as _i70;
import '../../features/story/data/data_source/story_data_source.dart' as _i47;
import '../../features/story/data/repository/story_repository_impl.dart'
    as _i49;
import '../../features/story/domain/repository/story_repository.dart' as _i48;
...
import '../../features/story/domain/useCases/get_width_and_height_usecase.dart'
    as _i69;
import '../../features/story/domain/useCases/upload_story_usecase.dart' as _i53;
...
import '../domin/usecases/upload_file_cloudinary_usecase.dart' as _i51;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i37.ReadAllMessagesUseCase>(
      () => _i37.ReadAllMessagesUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i38.ReceiveMessageUseCase>(
      () => _i38.ReceiveMessageUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i39.RegisterGuestUseCase>(
      () => _i39.RegisterGuestUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i40.RejectCallUseCase>(
      () => _i40.RejectCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i41.SaveContactsUseCase>(
      () => _i41.SaveContactsUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i42.SendMessageUseCase>(
      () => _i42.SendMessageUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i43.SendOtpUseCase>(
      () => _i43.SendOtpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i44.SensitiveConnectivityBloc>(
      () => _i44.SensitiveConnectivityBloc());
  await gh.singletonAsync<_i45.SharedPreferences>(
    () => appModule.sharedPreferences,
    preResolve: true,
  );
  gh.factory<_i46.StoreFcmUseCase>(
      () => _i46.StoreFcmUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i47.StoriesDataSource>(() => _i47.StoriesDataSource());
  gh.lazySingleton<_i48.StoryRepository>(
      () => _i49.StoryRepositoryImpl(gh<_i47.StoriesDataSource>()));
  gh.factory<_i50.UpdateNameUseCase>(
      () => _i50.UpdateNameUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i51.UploadFileCloudinaryUseCase>(
      () => _i51.UploadFileCloudinaryUseCase(gh<_i15.CommonUseRepository>()));
  gh.factory<_i52.UploadFileUseCase>(
      () => _i52.UploadFileUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i53.UploadStoryUseCase>(
      () => _i53.UploadStoryUseCase(gh<_i48.StoryRepository>()));
  gh.factory<_i54.VerifyGuestPhoneUseCase>(
      () => _i54.VerifyGuestPhoneUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i55.VerifyOtpSignInUseCase>(
      () => _i55.VerifyOtpSignInUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i56.VerifyOtpSignUpUseCase>(
      () => _i56.VerifyOtpSignUpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i57.VideoCallUseCase>(
      () => _i57.VideoCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i58.AddStoryToOurServerUseCase>(
      () => _i58.AddStoryToOurServerUseCase(gh<_i48.StoryRepository>()));
  gh.factory<_i59.AnswerCallUseCase>(
      () => _i59.AnswerCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i60.AuthBloc>(() => _i60.AuthBloc(
        ...
        gh<_i46.StoreFcmUseCase>(),
        gh<_i50.UpdateNameUseCase>(),
        gh<_i39.RegisterGuestUseCase>(),
        gh<_i43.SendOtpUseCase>(),
        gh<_i22.GetCustomerInfoUseCase>(),
        gh<_i54.VerifyGuestPhoneUseCase>(),
        gh<_i55.VerifyOtpSignInUseCase>(),
        gh<_i26.GetUserCountryUseCase>(),
        gh<_i56.VerifyOtpSignUpUseCase>(),
      ));
  gh.lazySingleton<_i61.CallsBloc>(() => _i61.CallsBloc(
        gh<_i40.RejectCallUseCase>(),
        gh<_i57.VideoCallUseCase>(),
        gh<_i59.AnswerCallUseCase>(),
        gh<_i20.GetAgoraTokenUseCase>(),
      ));
  gh.factory<_i62.ChangeChatPropertyUseCase>(
      () => _i62.ChangeChatPropertyUseCase(gh<_i12.ChatRepository>()));
  gh.lazySingleton<_i63.ChatBloc>(() => _i63.ChatBloc(
        gh<_i21.GetContactsUseCase>(),
        gh<_i25.GetMyChatsUseCase>(),
        gh<_i41.SaveContactsUseCase>(),
        gh<_i42.SendMessageUseCase>(),
        gh<_i23.GetMessagesBetweenUseCase>(),
        gh<_i51.UploadFileCloudinaryUseCase>(),
        gh<_i24.GetMessagesForChatUseCase>(),
        gh<_i18.DeleteChatUseCase>(),
        gh<_i62.ChangeChatPropertyUseCase>(),
        gh<_i52.UploadFileUseCase>(),
        gh<_i37.ReadAllMessagesUseCase>(),
        gh<_i38.ReceiveMessageUseCase>(),
      ));
  gh.singleton<_i7.Dio>(appModule.dio(
    gh<_i7.BaseOptions>(),
    gh<_i31.Logger>(),
  ));
  gh.factory<_i64.GetHomeSectionsUseCase>(
      () => _i64.GetHomeSectionsUseCase(gh<_i29.HomeRepository>()));
  gh.factory<_i65.GetMainCategoriesUseCase>(
      () => _i65.GetMainCategoriesUseCase(gh<_i29.HomeRepository>()));
  gh.factory<_i66.GetProductsWithoutFiltersUseCase>(
      () => _i66.GetProductsWithoutFiltersUseCase(gh<_i29.HomeRepository>()));
  gh.factory<_i67.GetStartingSettingsUseCase>(
      () => _i67.GetStartingSettingsUseCase(gh<_i29.HomeRepository>()));
  gh.factory<_i68.GetStoryUseCase>(
      () => _i68.GetStoryUseCase(gh<_i48.StoryRepository>()));
  gh.factory<_i69.GetWidthAndHeightUseCase>(
      () => _i69.GetWidthAndHeightUseCase(gh<_i48.StoryRepository>()));
  gh.lazySingleton<_i70.HomeBloc>(() => _i70.HomeBloc(
        gh<_i64.GetHomeSectionsUseCase>(),
        gh<_i65.GetMainCategoriesUseCase>(),
