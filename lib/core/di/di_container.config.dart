...
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i74;
import '../../features/calls/domain/useCase/delete_Message.dart' as _i75;
import '../../features/calls/domain/useCase/get_agora_token_use_case.dart'
    as _i76;
import '../../features/calls/domain/useCase/get_missed_call_count.dart' as _i77;
import '../../features/calls/domain/useCase/get_my_calls.dart' as _i78;
import '../../features/calls/domain/useCase/make_call_usecase.dart' as _i79;
import '../../features/calls/domain/useCase/reject_call_usecase.dart' as _i80;
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i81;
...
import '../../features/chat/data/repositories/chat_repository_impl.dart'
    as _i56;
import '../../features/chat/domain/repositories/chat_repository.dart' as _i55;
import '../../features/chat/domain/use_cases/change_chat_property_usecase.dart'
    as _i59;
import '../../features/chat/domain/use_cases/delete_chat_usecase.dart' as _i60;
import '../../features/chat/domain/use_cases/get_contacts_usecase.dart' as _i61;
import '../../features/chat/domain/use_cases/get_date_time.dart' as _i62;
...
import '../../features/chat/domain/use_cases/get_messages_for_chat_usecase.dart'
    as _i66;
import '../../features/chat/domain/use_cases/get_my_chats_usecase.dart' as _i67;
...
import '../../features/chat/domain/use_cases/send_error_to_server_usecase.dart'
    as _i71;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i72;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i73;
...
import '../../features/home/domain/use_cases/get_stories_for_product_usecase.dart'
    as _i49;
import '../../features/home/presentation/manager/home_bloc.dart' as _i54;
...
import '../domin/usecases/upload_file_cloudinary_usecase.dart' as _i57;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i55.ChatRepository>(
      () => _i56.ChatRepositoryImpl(gh<_i8.ChatRemoteDataSource>()));
  gh.factory<_i57.UploadFileCloudinaryUseCase>(
      () => _i57.UploadFileCloudinaryUseCase(gh<_i50.CommonUseRepository>()));
  gh.factory<_i58.CreateUserUseCase>(
      () => _i58.CreateUserUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i59.ChangeChatPropertyUseCase>(
      () => _i59.ChangeChatPropertyUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i60.DeleteChatUseCase>(
      () => _i60.DeleteChatUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i61.GetContactsUseCase>(
      () => _i61.GetContactsUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i62.GetDateTimeUseCase>(
      () => _i62.GetDateTimeUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i63.GetWidthAndHeightUseCase>(
      () => _i63.GetWidthAndHeightUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i64.GetMediaCountUseCase>(
      () => _i64.GetMediaCountUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i65.GetMessagesBetweenUseCase>(
      () => _i65.GetMessagesBetweenUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i66.GetMessagesForChatUseCase>(
      () => _i66.GetMessagesForChatUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i67.GetMyChatsUseCase>(
      () => _i67.GetMyChatsUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i68.ReadAllMessagesUseCase>(
      () => _i68.ReadAllMessagesUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i69.ReceiveMessageUseCase>(
      () => _i69.ReceiveMessageUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i70.SaveContactsUseCase>(
      () => _i70.SaveContactsUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i71.SendErrorToServerUseCase>(
      () => _i71.SendErrorToServerUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i72.SendMessageUseCase>(
      () => _i72.SendMessageUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i73.UploadFileUseCase>(
      () => _i73.UploadFileUseCase(gh<_i55.ChatRepository>()));
  gh.factory<_i74.AnswerCallUseCase>(
      () => _i74.AnswerCallUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i75.DeleteMessageUseCase>(
      () => _i75.DeleteMessageUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i76.GetAgoraTokenUseCase>(
      () => _i76.GetAgoraTokenUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i77.GetMissedCalCountUseCase>(
      () => _i77.GetMissedCalCountUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i78.GetMyCallsUseCase>(
      () => _i78.GetMyCallsUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i79.MakeCallUseCase>(
      () => _i79.MakeCallUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i80.RejectCallUseCase>(
      () => _i80.RejectCallUseCase(gh<_i52.CallsRepository>()));
  gh.factory<_i81.WatchMissedCallUseCase>(
      () => _i81.WatchMissedCallUseCase(gh<_i52.CallsRepository>()));
  gh.lazySingleton<_i82.StoryBloc>(() => _i82.StoryBloc(
        gh<_i57.UploadFileCloudinaryUseCase>(),
  ...
  gh.lazySingleton<_i83.ChatBloc>(() => _i83.ChatBloc(
        gh<_i61.GetContactsUseCase>(),
        gh<_i67.GetMyChatsUseCase>(),
        gh<_i70.SaveContactsUseCase>(),
        gh<_i72.SendMessageUseCase>(),
        gh<_i65.GetMessagesBetweenUseCase>(),
        gh<_i57.UploadFileCloudinaryUseCase>(),
        gh<_i66.GetMessagesForChatUseCase>(),
        gh<_i60.DeleteChatUseCase>(),
        gh<_i59.ChangeChatPropertyUseCase>(),
        gh<_i73.UploadFileUseCase>(),
        gh<_i68.ReadAllMessagesUseCase>(),
        gh<_i69.ReceiveMessageUseCase>(),
        gh<_i64.GetMediaCountUseCase>(),
        gh<_i62.GetDateTimeUseCase>(),
        gh<_i71.SendErrorToServerUseCase>(),
      ));
  gh.lazySingleton<_i84.CallsBloc>(() => _i84.CallsBloc(
        gh<_i80.RejectCallUseCase>(),
        gh<_i79.MakeCallUseCase>(),
        gh<_i78.GetMyCallsUseCase>(),
        gh<_i81.WatchMissedCallUseCase>(),
        gh<_i74.AnswerCallUseCase>(),
        gh<_i77.GetMissedCalCountUseCase>(),
        gh<_i76.GetAgoraTokenUseCase>(),
        gh<_i75.DeleteMessageUseCase>(),
      ));
  gh.lazySingleton<_i85.AuthBloc>(() => _i85.AuthBloc(
        gh<_i39.UpdateStoriesUserUseCase>(),
        gh<_i37.UpdateChatUserNameUseCase>(),
        gh<_i58.CreateUserUseCase>(),
