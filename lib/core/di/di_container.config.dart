...
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i56;
...
import '../../features/story/domain/useCases/add_story_to_our_server_usecase.dart'
    as _i53;
import '../../features/story/domain/useCases/get_stories_usecase.dart' as _i60;
...
import '../../features/story/presentation/bloc/story_bloc.dart' as _i63;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i53.AddStoryToOurServerUseCase>(
      () => _i53.AddStoryToOurServerUseCase(gh<_i44.StoryRepository>()));
  ...
  gh.factory<_i55.ChangeChatPropertyUseCase>(
      () => _i55.ChangeChatPropertyUseCase(gh<_i9.ChatRepository>()));
  ...
  gh.factory<_i57.GetHomeSectionsUseCase>(
      () => _i57.GetHomeSectionsUseCase(gh<_i25.HomeRepository>()));
  gh.factory<_i58.GetMainCategoriesUseCase>(
      () => _i58.GetMainCategoriesUseCase(gh<_i25.HomeRepository>()));
  gh.factory<_i59.GetStartingSettingsUseCase>(
      () => _i59.GetStartingSettingsUseCase(gh<_i25.HomeRepository>()));
  gh.factory<_i60.GetStoryUseCase>(
      () => _i60.GetStoryUseCase(gh<_i44.StoryRepository>()));
  gh.factory<_i61.GetWidthAndHeightUseCase>(
      () => _i61.GetWidthAndHeightUseCase(gh<_i44.StoryRepository>()));
  gh.lazySingleton<_i62.HomeBloc>(() => _i62.HomeBloc(
        gh<_i57.GetHomeSectionsUseCase>(),
        gh<_i58.GetMainCategoriesUseCase>(),
        gh<_i59.GetStartingSettingsUseCase>(),
      ));
  gh.lazySingleton<_i63.StoryBloc>(() => _i63.StoryBloc(
        gh<_i47.UploadFileCloudinaryUseCase>(),
        gh<_i60.GetStoryUseCase>(),
        gh<_i61.GetWidthAndHeightUseCase>(),
        gh<_i49.UploadStoryUseCase>(),
        gh<_i53.AddStoryToOurServerUseCase>(),
      ));
  return getIt;
}
