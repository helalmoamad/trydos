...
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i50;
...
import '../../features/home/domain/use_cases/get_starting_settings_usecase.dart'
    as _i53;
import '../../features/home/presentation/manager/home_bloc.dart' as _i56;
...
import '../../features/story/domain/useCases/get_stories_usecase.dart' as _i54;
import '../../features/story/domain/useCases/get_width_and_height_usecase.dart'
    as _i55;
import '../../features/story/domain/useCases/upload_story_usecase.dart' as _i44;
import '../../features/story/presentation/bloc/story_bloc.dart' as _i57;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i44.UploadStoryUseCase>(
      () => _i44.UploadStoryUseCase(gh<_i40.StoryRepository>()));
  gh.factory<_i45.VerifyGuestPhoneUseCase>(
      () => _i45.VerifyGuestPhoneUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i46.VerifyOtpSignInUseCase>(
      () => _i46.VerifyOtpSignInUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i47.VerifyOtpSignUpUseCase>(
      () => _i47.VerifyOtpSignUpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i48.AuthBloc>(() => _i48.AuthBloc(
        ...
        gh<_i45.VerifyGuestPhoneUseCase>(),
        gh<_i46.VerifyOtpSignInUseCase>(),
        gh<_i19.GetUserCountryUseCase>(),
        gh<_i47.VerifyOtpSignUpUseCase>(),
      ));
  gh.factory<_i49.ChangeChatPropertyUseCase>(
      () => _i49.ChangeChatPropertyUseCase(gh<_i9.ChatRepository>()));
  gh.lazySingleton<_i50.ChatBloc>(() => _i50.ChatBloc(
        ...
        gh<_i49.ChangeChatPropertyUseCase>(),
  ...
  gh.factory<_i51.GetHomeSectionsUseCase>(
      () => _i51.GetHomeSectionsUseCase(gh<_i21.HomeRepository>()));
  gh.factory<_i52.GetMainCategoriesUseCase>(
      () => _i52.GetMainCategoriesUseCase(gh<_i21.HomeRepository>()));
  gh.factory<_i53.GetStartingSettingsUseCase>(
      () => _i53.GetStartingSettingsUseCase(gh<_i21.HomeRepository>()));
  gh.factory<_i54.GetStoryUseCase>(
      () => _i54.GetStoryUseCase(gh<_i40.StoryRepository>()));
  gh.factory<_i55.GetWidthAndHeightUseCase>(
      () => _i55.GetWidthAndHeightUseCase(gh<_i40.StoryRepository>()));
  gh.lazySingleton<_i56.HomeBloc>(() => _i56.HomeBloc(
        gh<_i51.GetHomeSectionsUseCase>(),
        gh<_i52.GetMainCategoriesUseCase>(),
        gh<_i53.GetStartingSettingsUseCase>(),
      ));
  gh.lazySingleton<_i57.StoryBloc>(() => _i57.StoryBloc(
        gh<_i54.GetStoryUseCase>(),
        gh<_i55.GetWidthAndHeightUseCase>(),
        gh<_i44.UploadStoryUseCase>(),
      ));
  return getIt;
}
