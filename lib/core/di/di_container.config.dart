...
import '../../features/calls/data/repositories/calls_repository_impl.dart'
    as _i50;
import '../../features/calls/domain/repositories/calls_repository.dart' as _i49;
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i70;
import '../../features/calls/domain/useCase/delete_Message.dart' as _i71;
import '../../features/calls/domain/useCase/get_agora_token_use_case.dart'
    as _i72;
import '../../features/calls/domain/useCase/get_missed_call_count.dart' as _i73;
import '../../features/calls/domain/useCase/get_my_calls.dart' as _i74;
import '../../features/calls/domain/useCase/make_call_usecase.dart' as _i75;
import '../../features/calls/domain/useCase/reject_call_usecase.dart' as _i76;
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i77;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i81;
import '../../features/chat/data/data_sources/chat_remote_datasource.dart'
    as _i8;
import '../../features/chat/data/repositories/chat_repository_impl.dart'
    as _i52;
import '../../features/chat/domain/repositories/chat_repository.dart' as _i51;
import '../../features/chat/domain/use_cases/change_chat_property_usecase.dart'
    as _i55;
import '../../features/chat/domain/use_cases/delete_chat_usecase.dart' as _i56;
import '../../features/chat/domain/use_cases/get_contacts_usecase.dart' as _i57;
import '../../features/chat/domain/use_cases/get_date_time.dart' as _i58;
...
import '../../features/chat/domain/use_cases/get_messages_for_chat_usecase.dart'
    as _i62;
import '../../features/chat/domain/use_cases/get_my_chats_usecase.dart' as _i63;
...
import '../../features/chat/domain/use_cases/send_error_to_server_usecase.dart'
    as _i67;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i68;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i69;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i80;
...
import '../../features/story/presentation/bloc/story_bloc.dart' as _i79;
import '../data/data_source/common_use_repo_data_source.dart' as _i3;
import '../data/repository/common_use_repository_impl.dart' as _i48;
import '../domin/repositories/common_use_repository.dart' as _i47;
import '../domin/repositories/prefs_repository.dart' as _i14;
import '../domin/usecases/upload_file_cloudinary_usecase.dart' as _i53;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i42.GetHomeSectionsUseCase>(
      () => _i42.GetHomeSectionsUseCase(gh<_i18.HomeRepository>()));
  ...
  gh.lazySingleton<_i47.CommonUseRepository>(
      () => _i48.CommonUseRepositoryImpl(gh<_i3.CommonUseRemoteDataSource>()));
  gh.lazySingleton<_i49.CallsRepository>(
      () => _i50.CallsRepositoryImpl(gh<_i7.CallsRemoteDataSource>()));
  gh.lazySingleton<_i51.ChatRepository>(
      () => _i52.ChatRepositoryImpl(gh<_i8.ChatRemoteDataSource>()));
  gh.factory<_i53.UploadFileCloudinaryUseCase>(
      () => _i53.UploadFileCloudinaryUseCase(gh<_i47.CommonUseRepository>()));
  gh.factory<_i54.CreateUserUseCase>(
      () => _i54.CreateUserUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i55.ChangeChatPropertyUseCase>(
      () => _i55.ChangeChatPropertyUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i56.DeleteChatUseCase>(
      () => _i56.DeleteChatUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i57.GetContactsUseCase>(
      () => _i57.GetContactsUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i58.GetDateTimeUseCase>(
      () => _i58.GetDateTimeUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i59.GetWidthAndHeightUseCase>(
      () => _i59.GetWidthAndHeightUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i60.GetMediaCountUseCase>(
      () => _i60.GetMediaCountUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i61.GetMessagesBetweenUseCase>(
      () => _i61.GetMessagesBetweenUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i62.GetMessagesForChatUseCase>(
      () => _i62.GetMessagesForChatUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i63.GetMyChatsUseCase>(
      () => _i63.GetMyChatsUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i64.ReadAllMessagesUseCase>(
      () => _i64.ReadAllMessagesUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i65.ReceiveMessageUseCase>(
      () => _i65.ReceiveMessageUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i66.SaveContactsUseCase>(
      () => _i66.SaveContactsUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i67.SendErrorToServerUseCase>(
      () => _i67.SendErrorToServerUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i68.SendMessageUseCase>(
      () => _i68.SendMessageUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i69.UploadFileUseCase>(
      () => _i69.UploadFileUseCase(gh<_i51.ChatRepository>()));
  gh.factory<_i70.AnswerCallUseCase>(
      () => _i70.AnswerCallUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i71.DeleteMessageUseCase>(
      () => _i71.DeleteMessageUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i72.GetAgoraTokenUseCase>(
      () => _i72.GetAgoraTokenUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i73.GetMissedCalCountUseCase>(
      () => _i73.GetMissedCalCountUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i74.GetMyCallsUseCase>(
      () => _i74.GetMyCallsUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i75.MakeCallUseCase>(
      () => _i75.MakeCallUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i76.RejectCallUseCase>(
      () => _i76.RejectCallUseCase(gh<_i49.CallsRepository>()));
  gh.factory<_i77.WatchMissedCallUseCase>(
      () => _i77.WatchMissedCallUseCase(gh<_i49.CallsRepository>()));
  gh.lazySingleton<_i78.HomeBloc>(() => _i78.HomeBloc(
        gh<_i42.GetHomeSectionsUseCase>(),
  ...
  gh.lazySingleton<_i79.StoryBloc>(() => _i79.StoryBloc(
        gh<_i53.UploadFileCloudinaryUseCase>(),
  ...
  gh.lazySingleton<_i80.ChatBloc>(() => _i80.ChatBloc(
        gh<_i57.GetContactsUseCase>(),
        gh<_i63.GetMyChatsUseCase>(),
        gh<_i66.SaveContactsUseCase>(),
        gh<_i68.SendMessageUseCase>(),
        gh<_i61.GetMessagesBetweenUseCase>(),
        gh<_i53.UploadFileCloudinaryUseCase>(),
        gh<_i62.GetMessagesForChatUseCase>(),
        gh<_i56.DeleteChatUseCase>(),
        gh<_i55.ChangeChatPropertyUseCase>(),
        gh<_i69.UploadFileUseCase>(),
        gh<_i64.ReadAllMessagesUseCase>(),
        gh<_i65.ReceiveMessageUseCase>(),
        gh<_i60.GetMediaCountUseCase>(),
        gh<_i58.GetDateTimeUseCase>(),
        gh<_i67.SendErrorToServerUseCase>(),
      ));
  gh.lazySingleton<_i81.CallsBloc>(() => _i81.CallsBloc(
        gh<_i76.RejectCallUseCase>(),
        gh<_i75.MakeCallUseCase>(),
        gh<_i74.GetMyCallsUseCase>(),
        gh<_i77.WatchMissedCallUseCase>(),
        gh<_i70.AnswerCallUseCase>(),
        gh<_i73.GetMissedCalCountUseCase>(),
        gh<_i72.GetAgoraTokenUseCase>(),
        gh<_i71.DeleteMessageUseCase>(),
      ));
  gh.factory<_i82.AuthBloc>(() => _i82.AuthBloc(
        gh<_i38.UpdateStoriesUserUseCase>(),
        gh<_i36.UpdateChatUserNameUseCase>(),
        gh<_i54.CreateUserUseCase>(),
