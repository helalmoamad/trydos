...
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i68;
...
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i66;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i70;
...
import '../../features/chat/domain/use_cases/send_error_to_server_usecase.dart'
    as _i48;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i49;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i61;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i72;
...
import '../../features/home/domain/use_cases/get_product_detail_without_related_products_uswcase.dart'
    as _i75;
import '../../features/home/domain/use_cases/get_products_usecase.dart' as _i76;
import '../../features/home/domain/use_cases/get_starting_settings_usecase.dart'
    as _i77;
import '../../features/home/presentation/manager/home_bloc.dart' as _i80;
import '../../features/story/data/data_source/story_data_source.dart' as _i54;
import '../../features/story/data/repository/story_repository_impl.dart'
    as _i56;
import '../../features/story/domain/repository/story_repository.dart' as _i55;
import '../../features/story/domain/useCases/add_story_to_our_server_usecase.dart'
    as _i67;
import '../../features/story/domain/useCases/get_stories_usecase.dart' as _i78;
...
import '../../features/story/domain/useCases/increase_viewers_usecase.dart'
    as _i81;
import '../../features/story/domain/useCases/upload_story_usecase.dart' as _i62;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i48.SendErrorToServerUseCase>(
      () => _i48.SendErrorToServerUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i49.SendMessageUseCase>(
      () => _i49.SendMessageUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i50.SendOtpUseCase>(
      () => _i50.SendOtpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i51.SensitiveConnectivityBloc>(
      () => _i51.SensitiveConnectivityBloc());
  await gh.singletonAsync<_i52.SharedPreferences>(
    () => appModule.sharedPreferences,
    preResolve: true,
  );
  gh.factory<_i53.StoreFcmUseCase>(
      () => _i53.StoreFcmUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i54.StoriesDataSource>(() => _i54.StoriesDataSource());
  gh.lazySingleton<_i55.StoryRepository>(
      () => _i56.StoryRepositoryImpl(gh<_i54.StoriesDataSource>()));
  gh.factory<_i57.UpdateChatUserNameUseCase>(
      () => _i57.UpdateChatUserNameUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i58.UpdateNameUseCase>(
      () => _i58.UpdateNameUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i59.UpdateStoriesUserUseCase>(
      () => _i59.UpdateStoriesUserUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i60.UploadFileCloudinaryUseCase>(
      () => _i60.UploadFileCloudinaryUseCase(gh<_i15.CommonUseRepository>()));
  gh.factory<_i61.UploadFileUseCase>(
      () => _i61.UploadFileUseCase(gh<_i12.ChatRepository>()));
  gh.factory<_i62.UploadStoryUseCase>(
      () => _i62.UploadStoryUseCase(gh<_i55.StoryRepository>()));
  gh.factory<_i63.VerifyGuestPhoneUseCase>(
      () => _i63.VerifyGuestPhoneUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i64.VerifyOtpSignInUseCase>(
      () => _i64.VerifyOtpSignInUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i65.VerifyOtpSignUpUseCase>(
      () => _i65.VerifyOtpSignUpUseCase(gh<_i5.AuthRepository>()));
  gh.factory<_i66.WatchMissedCallUseCase>(
      () => _i66.WatchMissedCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i67.AddStoryToOurServerUseCase>(
      () => _i67.AddStoryToOurServerUseCase(gh<_i55.StoryRepository>()));
  gh.factory<_i68.AnswerCallUseCase>(
      () => _i68.AnswerCallUseCase(gh<_i9.CallsRepository>()));
  gh.factory<_i69.AuthBloc>(() => _i69.AuthBloc(
        gh<_i59.UpdateStoriesUserUseCase>(),
        gh<_i57.UpdateChatUserNameUseCase>(),
        gh<_i17.CreateUserUseCase>(),
        gh<_i37.LoginToChatUseCase>(),
        gh<_i38.LoginToMarketUseCase>(),
        gh<_i39.LoginToStoriesUseCase>(),
        gh<_i53.StoreFcmUseCase>(),
        gh<_i58.UpdateNameUseCase>(),
        gh<_i45.RegisterGuestUseCase>(),
        gh<_i50.SendOtpUseCase>(),
        gh<_i23.GetCustomerInfoUseCase>(),
        gh<_i63.VerifyGuestPhoneUseCase>(),
        gh<_i64.VerifyOtpSignInUseCase>(),
        gh<_i31.GetUserCountryUseCase>(),
        gh<_i65.VerifyOtpSignUpUseCase>(),
      ));
  gh.lazySingleton<_i70.CallsBloc>(() => _i70.CallsBloc(
        gh<_i46.RejectCallUseCase>(),
        gh<_i40.MakeCallUseCase>(),
        gh<_i29.GetMyCallsUseCase>(),
        gh<_i66.WatchMissedCallUseCase>(),
        gh<_i68.AnswerCallUseCase>(),
        gh<_i28.GetMissedCalCountUseCase>(),
        gh<_i21.GetAgoraTokenUseCase>(),
        gh<_i20.DeleteMessageUseCase>(),
      ));
  gh.factory<_i71.ChangeChatPropertyUseCase>(
      () => _i71.ChangeChatPropertyUseCase(gh<_i12.ChatRepository>()));
  gh.lazySingleton<_i72.ChatBloc>(() => _i72.ChatBloc(
        ...
        gh<_i71.ChangeChatPropertyUseCase>(),
        gh<_i61.UploadFileUseCase>(),
        gh<_i43.ReadAllMessagesUseCase>(),
        gh<_i44.ReceiveMessageUseCase>(),
        gh<_i25.GetMediaCountUseCase>(),
        gh<_i24.GetDateTimeUseCase>(),
        gh<_i48.SendErrorToServerUseCase>(),
      ));
  gh.singleton<_i7.Dio>(() => appModule.dio(
        gh<_i7.BaseOptions>(),
        gh<_i36.Logger>(),
      ));
  gh.factory<_i73.GetHomeSectionsUseCase>(
      () => _i73.GetHomeSectionsUseCase(gh<_i34.HomeRepository>()));
  gh.factory<_i74.GetMainCategoriesUseCase>(
      () => _i74.GetMainCategoriesUseCase(gh<_i34.HomeRepository>()));
  gh.factory<_i75.GetProductDetailWithoutRelatedProductsUseCase>(() =>
      _i75.GetProductDetailWithoutRelatedProductsUseCase(
          gh<_i34.HomeRepository>()));
  gh.factory<_i76.GetProductsWithoutFiltersUseCase>(
      () => _i76.GetProductsWithoutFiltersUseCase(gh<_i34.HomeRepository>()));
  gh.factory<_i77.GetStartingSettingsUseCase>(
      () => _i77.GetStartingSettingsUseCase(gh<_i34.HomeRepository>()));
  gh.factory<_i78.GetStoryUseCase>(
      () => _i78.GetStoryUseCase(gh<_i55.StoryRepository>()));
  gh.factory<_i79.GetWidthAndHeightUseCase>(
      () => _i79.GetWidthAndHeightUseCase(gh<_i55.StoryRepository>()));
  gh.lazySingleton<_i80.HomeBloc>(() => _i80.HomeBloc(
        gh<_i73.GetHomeSectionsUseCase>(),
        gh<_i74.GetMainCategoriesUseCase>(),
        gh<_i75.GetProductDetailWithoutRelatedProductsUseCase>(),
        gh<_i77.GetStartingSettingsUseCase>(),
        gh<_i76.GetProductsWithoutFiltersUseCase>(),
      ));
  gh.factory<_i81.IncreaseViewersUseCase>(
      () => _i81.IncreaseViewersUseCase(gh<_i55.StoryRepository>()));
  gh.lazySingleton<_i82.StoryBloc>(() => _i82.StoryBloc(
        gh<_i60.UploadFileCloudinaryUseCase>(),
        gh<_i78.GetStoryUseCase>(),
        gh<_i79.GetWidthAndHeightUseCase>(),
        gh<_i62.UploadStoryUseCase>(),
        gh<_i81.IncreaseViewersUseCase>(),
        gh<_i67.AddStoryToOurServerUseCase>(),
      ));
  return getIt;
}
