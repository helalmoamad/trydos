...
import '../../features/calls/data/repositories/calls_repository_impl.dart'
    as _i60;
import '../../features/calls/domain/repositories/calls_repository.dart' as _i59;
import '../../features/calls/domain/useCase/answer_call_usecase.dart' as _i80;
import '../../features/calls/domain/useCase/delete_Message.dart' as _i81;
import '../../features/calls/domain/useCase/get_agora_token_use_case.dart'
    as _i82;
import '../../features/calls/domain/useCase/get_missed_call_count.dart' as _i83;
import '../../features/calls/domain/useCase/get_my_calls.dart' as _i84;
import '../../features/calls/domain/useCase/make_call_usecase.dart' as _i85;
import '../../features/calls/domain/useCase/reject_call_usecase.dart' as _i86;
import '../../features/calls/domain/useCase/watch_missed_call.dart' as _i87;
import '../../features/calls/presentation/bloc/calls_bloc.dart' as _i90;
import '../../features/chat/data/data_sources/chat_remote_datasource.dart'
    as _i8;
import '../../features/chat/data/repositories/chat_repository_impl.dart'
    as _i62;
import '../../features/chat/domain/repositories/chat_repository.dart' as _i61;
import '../../features/chat/domain/use_cases/change_chat_property_usecase.dart'
    as _i65;
import '../../features/chat/domain/use_cases/delete_chat_usecase.dart' as _i66;
import '../../features/chat/domain/use_cases/get_contacts_usecase.dart' as _i67;
import '../../features/chat/domain/use_cases/get_date_time.dart' as _i68;
...
import '../../features/chat/domain/use_cases/get_messages_for_chat_usecase.dart'
    as _i72;
import '../../features/chat/domain/use_cases/get_my_chats_usecase.dart' as _i73;
...
import '../../features/chat/domain/use_cases/send_error_to_server_usecase.dart'
    as _i77;
import '../../features/chat/domain/use_cases/send_message_usecase.dart' as _i78;
import '../../features/chat/domain/use_cases/upload_file_usecase.dart' as _i79;
import '../../features/chat/presentation/manager/chat_bloc.dart' as _i89;
...
import '../../features/home/domain/use_cases/update_item_from_cart_usecase.dart'
    as _i55;
import '../../features/home/presentation/manager/home_bloc.dart' as _i58;
...
import '../../features/story/presentation/bloc/story_bloc.dart' as _i88;
import '../data/data_source/common_use_repo_data_source.dart' as _i3;
import '../data/repository/common_use_repository_impl.dart' as _i57;
import '../domin/repositories/common_use_repository.dart' as _i56;
import '../domin/repositories/prefs_repository.dart' as _i14;
import '../domin/usecases/upload_file_cloudinary_usecase.dart' as _i63;
import 'di_container.dart' as _i92;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.lazySingleton<_i56.CommonUseRepository>(
      () => _i57.CommonUseRepositoryImpl(gh<_i3.CommonUseRemoteDataSource>()));
  ...
  gh.lazySingleton<_i59.CallsRepository>(
      () => _i60.CallsRepositoryImpl(gh<_i7.CallsRemoteDataSource>()));
  gh.lazySingleton<_i61.ChatRepository>(
      () => _i62.ChatRepositoryImpl(gh<_i8.ChatRemoteDataSource>()));
  gh.factory<_i63.UploadFileCloudinaryUseCase>(
      () => _i63.UploadFileCloudinaryUseCase(gh<_i56.CommonUseRepository>()));
  gh.factory<_i64.CreateUserUseCase>(
      () => _i64.CreateUserUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i65.ChangeChatPropertyUseCase>(
      () => _i65.ChangeChatPropertyUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i66.DeleteChatUseCase>(
      () => _i66.DeleteChatUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i67.GetContactsUseCase>(
      () => _i67.GetContactsUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i68.GetDateTimeUseCase>(
      () => _i68.GetDateTimeUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i69.GetWidthAndHeightUseCase>(
      () => _i69.GetWidthAndHeightUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i70.GetMediaCountUseCase>(
      () => _i70.GetMediaCountUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i71.GetMessagesBetweenUseCase>(
      () => _i71.GetMessagesBetweenUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i72.GetMessagesForChatUseCase>(
      () => _i72.GetMessagesForChatUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i73.GetMyChatsUseCase>(
      () => _i73.GetMyChatsUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i74.ReadAllMessagesUseCase>(
      () => _i74.ReadAllMessagesUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i75.ReceiveMessageUseCase>(
      () => _i75.ReceiveMessageUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i76.SaveContactsUseCase>(
      () => _i76.SaveContactsUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i77.SendErrorToServerUseCase>(
      () => _i77.SendErrorToServerUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i78.SendMessageUseCase>(
      () => _i78.SendMessageUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i79.UploadFileUseCase>(
      () => _i79.UploadFileUseCase(gh<_i61.ChatRepository>()));
  gh.factory<_i80.AnswerCallUseCase>(
      () => _i80.AnswerCallUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i81.DeleteMessageUseCase>(
      () => _i81.DeleteMessageUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i82.GetAgoraTokenUseCase>(
      () => _i82.GetAgoraTokenUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i83.GetMissedCalCountUseCase>(
      () => _i83.GetMissedCalCountUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i84.GetMyCallsUseCase>(
      () => _i84.GetMyCallsUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i85.MakeCallUseCase>(
      () => _i85.MakeCallUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i86.RejectCallUseCase>(
      () => _i86.RejectCallUseCase(gh<_i59.CallsRepository>()));
  gh.factory<_i87.WatchMissedCallUseCase>(
      () => _i87.WatchMissedCallUseCase(gh<_i59.CallsRepository>()));
  gh.lazySingleton<_i88.StoryBloc>(() => _i88.StoryBloc(
        gh<_i63.UploadFileCloudinaryUseCase>(),
  ...
  gh.lazySingleton<_i89.ChatBloc>(() => _i89.ChatBloc(
        gh<_i67.GetContactsUseCase>(),
        gh<_i73.GetMyChatsUseCase>(),
        gh<_i76.SaveContactsUseCase>(),
        gh<_i78.SendMessageUseCase>(),
        gh<_i71.GetMessagesBetweenUseCase>(),
        gh<_i63.UploadFileCloudinaryUseCase>(),
        gh<_i72.GetMessagesForChatUseCase>(),
        gh<_i66.DeleteChatUseCase>(),
        gh<_i65.ChangeChatPropertyUseCase>(),
        gh<_i79.UploadFileUseCase>(),
        gh<_i74.ReadAllMessagesUseCase>(),
        gh<_i75.ReceiveMessageUseCase>(),
        gh<_i70.GetMediaCountUseCase>(),
        gh<_i68.GetDateTimeUseCase>(),
        gh<_i77.SendErrorToServerUseCase>(),
      ));
  gh.lazySingleton<_i90.CallsBloc>(() => _i90.CallsBloc(
        gh<_i86.RejectCallUseCase>(),
        gh<_i85.MakeCallUseCase>(),
        gh<_i84.GetMyCallsUseCase>(),
        gh<_i87.WatchMissedCallUseCase>(),
        gh<_i80.AnswerCallUseCase>(),
        gh<_i83.GetMissedCalCountUseCase>(),
        gh<_i82.GetAgoraTokenUseCase>(),
        gh<_i81.DeleteMessageUseCase>(),
      ));
  gh.lazySingleton<_i91.AuthBloc>(() => _i91.AuthBloc(
        gh<_i39.UpdateStoriesUserUseCase>(),
        gh<_i37.UpdateChatUserNameUseCase>(),
        gh<_i64.CreateUserUseCase>(),
