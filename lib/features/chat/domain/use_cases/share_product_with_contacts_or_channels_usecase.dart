...
@injectable
class ShareProductWithContactsOrChannelsUsecase extends UseCase<Message , ShareProductWithContactsOrChannelsParams>{
  final ChatRepository repository;

  ShareProductWithContactsOrChannelsUsecase(this.repository);

  @override
  Future<Either<Failure, Message>> call(ShareProductWithContactsOrChannelsParams params) {
...
class ShareProductWithContactsOrChannelsParams{
 ...
 ShareProductWithContactsOrChannelsParams({
  ...
  Map<String, dynamic> get map=> {
    ...
    'channel_ids' : channelIds.toString(),
    'receiver_ids' : receiverIds.toString(),
  };
}