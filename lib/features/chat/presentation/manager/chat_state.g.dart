...
ChatState _$ChatStateFromJson(Map<String, dynamic> json) => ChatState(
  ...
  getMediaCountStatus:
      $enumDecodeNullable(
        _$GetMediaCountStatusEnumMap,
        json['getMediaCountStatus'],
      ) ??
      GetMediaCountStatus.init,
  resendMessageStatus:
      $enumDecodeNullable(
        _$ResendMessageStatusEnumMap,
        json['resendMessageStatus'],
      ) ??
  ...
  videoCountInEachChat: (json['videoCountInEachChat'] as num?)?.toInt() ?? 0,
  ...
  getContactsStatus:
      $enumDecodeNullable(
        _$GetContactsStatusEnumMap,
        json['getContactsStatus'],
      ) ??
  ...
  saveContactsStatus:
      $enumDecodeNullable(
        _$SaveContactsStatusEnumMap,
        json['saveContactsStatus'],
      ) ??
      SaveContactsStatus.init,
  sendMessageStatus:
      $enumDecodeNullable(
        _$SendMessageStatusEnumMap,
        json['sendMessageStatus'],
      ) ??
      SendMessageStatus.init,
  readMessagesStatus:
      $enumDecodeNullable(
        _$ResetReadMessagesStatusEnumMap,
        json['readMessagesStatus'],
      ) ??
      ResetReadMessagesStatus.init,
  deleteChatStatus:
      $enumDecodeNullable(
        _$DeleteChatStatusEnumMap,
        json['deleteChatStatus'],
      ) ??
  ...
  receiveMessageStatus:
      $enumDecodeNullable(
        _$ReceiveMessageStatusEnumMap,
        json['receiveMessageStatus'],
      ) ??
      ReceiveMessageStatus.init,
  getChatsStatus:
      $enumDecodeNullable(_$GetChatsStatusEnumMap, json['getChatsStatus']) ??
      GetChatsStatus.init,
  ...
  chats:
      ...
      const [],
  pinnedChats:
      (json['pinnedChats'] as List<dynamic>?)
          ?.map((e) => Chat.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  currentMessage:
      (json['currentMessage'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  currentFailedMessage:
      (json['currentFailedMessage'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
...
Map<String, dynamic> _$ChatStateToJson(ChatState instance) => <String, dynamic>{
  ...
  'getContactsStatus': _$GetContactsStatusEnumMap[instance.getContactsStatus]!,
  ...
  'currentRequestIdForAvoidPreRequest':
      instance.currentRequestIdForAvoidPreRequest,
  'getMessagesBetweenStatus':
      _$GetMessagesBetweenStatusEnumMap[instance.getMessagesBetweenStatus]!,
  'notifyThatIReceivedMessageStatus':
      _$NotifyThatIReceivedMessageStatusEnumMap[instance
          .notifyThatIReceivedMessageStatus]!,
  'changeMessageStateFromPusherStatus':
      _$ChangeMessageStateFromPusherStatusEnumMap[instance
          .changeMessageStateFromPusherStatus]!,
  'changeChatPropertyStatus':
  ...
  'getOrderRecipientIdStatus':
      _$GetOrderRecipientIdStatusEnumMap[instance.getOrderRecipientIdStatus]!,
  ...
  'chatToNavigateFromTerminated': instance.chatToNavigateFromTerminated
      ?.toJson(),
  'getSharedProductCountStatus':
      _$GetSharedProductCountStatusEnumMap[instance
          .getSharedProductCountStatus],
  'createAnewChat': instance.createAnewChat,
  'newSortedChatsByDate': instance.newSortedChatsByDate?.map(
