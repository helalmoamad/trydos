      ...
      builder: (context, state) {
        return Padding(
          ...
          child: SwipeTo(
            ...
            offsetDx: 0.15,
            onRightSwipe: () {
              BlocProvider.of<AppBloc>(context).add(RefreshChatInputField(true, 'voice',senderParentMessageId: widget.senderId ,widget.isSent,messageId: widget.messageId,time: widget.time,message: 'Voice'));
            },
            child: Row(
                                              ...
                                              if (widget.isSent) ...{
                                                ...
                                                SvgPicture.asset(
                                                  (state.sendMessageStatus ==
                                                      ...
                                                      : widget.isRead ? AppAssets.messageReadArrowSvg
                                                  :AppAssets
                                                          .messageSentArrowSvg,
                                                  width: 10.sp,
                                                  height: 10.sp,
