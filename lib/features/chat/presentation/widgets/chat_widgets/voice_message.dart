...
class _VoiceMessageState extends State<VoiceMessage> {
  ...
  getAudioDuration() async {
    if (widget.file != null) {
      ...
      audioSource=UrlSource(Urls.baseUrlWithHttp + widget.fileUrl!);
      await audioPlayer.setSource(audioSource);
    }
      ...
      child: SwipeTo(
        ...
        onRightSwipe: () {
          BlocProvider.of<AppBloc>(context)
              .add(RefreshChatInputField(true, 'voice', widget.isSent));
        },
        child: Row(
          mainAxisAlignment:
                ...
                Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color:
                                    context.colorScheme.black.withOpacity(0.05),
                                        ...
                                        children: [
                                          if (widget.isSent) ...{
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                Container(
                                                    ...
                                                    child: Center(
                                                      child: ValueListenableBuilder<bool>(
                                                        valueListenable: durationChangedNotifier,
                                                        builder: (context , durationChanged , _) {
                                                          print(position);
                                                          print(isPlaying);
                                                          return Text(
                                                              (isPlaying)
                                            ...
                                            InkWell(
                                              onTap: audioToggle,
                                              child: SvgPicture.asset(
                                              isPlaying ? AppAssets.playSvg : AppAssets.pauseSvg,
                                              width: 20.sp,
                                              height: 20.sp,
                                            ),),
                                            26.horizontalSpace,
                    ...
                    widget.isFirstMessage
                        ? Transform.translate(
                            offset: Offset(widget.isSent ? 20.w : -20.w, 0),
                            child: Stack(
                              alignment: Alignment.center,
                              children: [
                                Container(
