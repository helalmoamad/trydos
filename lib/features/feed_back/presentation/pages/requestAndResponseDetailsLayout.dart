...
class RequestAndResponseDetailsLayout extends StatelessWidget {
  ...
  TextStyle titleStyle(BuildContext context) => context.textTheme.subtitle1!.copyWith(
      fontWeight: FontWeight.w700, color: context.colorScheme.tertiary);

  TextStyle bodyStyle(BuildContext context) => context.textTheme.subtitle1!.copyWith(
