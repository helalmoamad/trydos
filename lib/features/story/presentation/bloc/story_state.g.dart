...
StoryState _$StoryStateFromJson(Map<String, dynamic> json) => StoryState(
  ...
  uploadStoryStatus:
      $enumDecodeNullable(
        _$UploadStoryStatusEnumMap,
        json['uploadStoryStatus'],
      ) ??
  ...
  getStoriesStatus:
      $enumDecodeNullable(
        _$GetStoriesStatusEnumMap,
        json['getStoriesStatus'],
      ) ??
      GetStoriesStatus.init,
  deleteStoryStatus:
      $enumDecodeNullable(
        _$DeleteStoryStatusEnumMap,
        json['deleteStoryStatus'],
      ) ??
...
Map<String, dynamic> _$StoryStateToJson(
  StoryState instance,
) => <String, dynamic>{
  'uploadStoryStatus': _$UploadStoryStatusEnumMap[instance.uploadStoryStatus]!,
  'uploadStoryCloudinaryStatus':
      _$UploadStoryCloudinaryStatusEnumMap[instance
          .uploadStoryCloudinaryStatus]!,
  ...
  'deleteStoryStatus': _$DeleteStoryStatusEnumMap[instance.deleteStoryStatus]!,
