        ...
        child:
            ...
            ValueListenableBuilder<int>(
                ...
                builder: (context, focused, _) {
                  return SizedBox(width: 90,height: 120,
...
//                                context.read<StoryBloc>().add(StorySelectedEvent(initialStory: indexOfInitialStory, selected: index));
//
//                                Navigator.of(context).push(MaterialPageRoute(builder: (_)=>BlocProvider<StoryBloc>.value(value: BlocProvider.of<StoryBloc>(context),child: StoryCollection(index))));

                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (_) => StoryCollection(index)));
                              },
                              onLongPressStart: (details) {
                                resizeStories.value = (details.globalPosition.dx +
