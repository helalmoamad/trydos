...
@injectable
class AddStoryToOurServerUseCase extends UseCase<stories.Datum?,AddStoryToOurServerParams>
{
  ...
  @override
  Future<Either<Failure, stories.Datum?>> call(AddStoryToOurServerParams params) {
