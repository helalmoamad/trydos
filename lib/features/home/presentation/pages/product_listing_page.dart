...
class _ProductListingPageState extends State<ProductListingPage> {
  ...
  void initState() {
    ...
    //   ));
    // }
    print('121212121 ${homeBloc.state.getProductListingWithFiltersPaginationModels['${widget.boutiqueSlug}' +
        '${(true) ? 'withoutFilter' : ""}' +
                        ...
                        return ValueListenableBuilder<bool>(
                            ...
                            builder: (context, isExpanded, _) {
                              ...
                              return BlocBuilder<HomeBloc, HomeState>(
                                ...
                                previous.getProductFiltersModel[key]
                                    ?.filters?.totalSize !=
                                    current.getProductFiltersModel[key]?.filters
                                        ?.totalSize,
                                builder: (context, state) {
                                                            ...
                                                            if (widget
                                                              ...
                                                              homeBloc.add(ChangeAppliedFiltersEvent(
                                                                  ...
                                                                  category: widget
                                                                      .category,
                                                                  filtersAppliedByUser:
                                                                  GetProductFiltersModel(filters: homeBloc.state.appliedFiltersByUser[key]?.filters),
                                                                  resetAppliedFilters: false));
                                                              homeBloc.add(
                                                              ...
                                                              AnimatedSearchBar(
                                                                ...
                                                                onClickClose:
                                                                  ...
                                                                  if (!isExpanded &&
                                                                    ...
                                                                    print("66666666666666dddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");

                                                                    Filter
                                                                    filters =
                                                                        homeBloc.state.appliedFiltersByUser[key]?.filters ?? Filter();
                                                                    homeBloc.add(ChangeAppliedFiltersEvent(
                                                                        boutiqueSlug: widget.boutiqueSlug,
                                                                        category: widget.category,
                                                                  ...
                                                                  if (isExpanded &&
                                                                    ...
                                                                    Filter
                                                                    filters =
                                                                        homeBloc.state.choosedFiltersByUser[key]?.filters ?? Filter();
                                                                    homeBloc.add(ChangeSelectedFiltersEvent(
                                                                        fromHomePageSearch: widget.fromSearch,
                                                                        boutiqueSlug: widget.boutiqueSlug,
                                                                ...
                                                                InputDecoration(
                                                                  ...
                                                                  OutlineInputBorder(
                                                                    borderSide:
                                                                    BorderSide(color: focusNode.hasFocus ? Color(0xffE6E6E6) : Color(0xffF8F8F8), width: 0.4),
                                                                    borderRadius:
                                                                  ...
                                                                  OutlineInputBorder(
                                                                    borderSide:
                                                                    BorderSide(color: context.colorScheme.error, width: 0.4),
                                                                    borderRadius:
                                                                    BorderRadius.circular(kbrBorderTextField),
                                                                  ),
                                                                  focusedErrorBorder:
                                                                ...
                                                                text) {
                                                                  if (isExpanded) {
                                                                    ...
                                                                    if (text.length < 3 &&
                                                                        resetSearchAfterSearchingWhileRemoveSearch) {
                                                                      resetSearchAfterSearchingWhileRemoveSearch = false;
                                                                      homeBloc.add(ChangeSelectedFiltersEvent(fromHomePageSearch: widget.fromSearch, boutiqueSlug: widget.boutiqueSlug, filtersChoosedByUser: GetProductFiltersModel(filters: filters.copyWithSaveOtherField(prices: filters.prices, searchText: null))));
                                                                    }
                                                                    return;
                                                                  }
                                                                  if (text.length >
                                                                      2) {
                                                                    print("8888888888888dddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
                                                                  ...
                                                                  if (text.length < 3 &&
                                                                    ...
                                                                    filters =
                                                                        homeBloc.state.appliedFiltersByUser[key]?.filters ?? Filter();
                                                                    print("777777777777777dddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
                                                              ...
                                                              Row(
                                                                children: [
                                                                  ...
                                                                  BlocBuilder<
                                                                    ...
                                                                    buildWhen:
                                                                        (p, c) {
                                                                      return (p.getProductListingWithFiltersPaginationModels != c.getProductListingWithFiltersPaginationModels);
                                                                    },
                                                                    builder:
                                                                        (context, state) {
                                                        ...
                                                        await FirebaseAnalytics
                                                            ...
                                                            parameters: {
                                                              ...
                                                              GetIt.I<PrefsRepository>()
                                                                  .currentEvent,
                                                              "device_language": LanguageService.languageCode ==
                                                                  'ar'
                                                                  ? 'ae'
                                                                  : LanguageService
                                                                  .languageCode,
