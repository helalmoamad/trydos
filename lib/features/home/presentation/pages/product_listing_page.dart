...
class _ProductListingPageState extends State<ProductListingPage> {
  ...
  void initState() {
    ...
    // }
    if (homeBloc.state.boutiquesThatDidPrefetch[key] == true && homeBloc
        .boutiquesThatEnablesToRequestItsProductsUsingFiveFilters[key] ==
        null) {
                  ...
                  child: ValueListenableBuilder<Tuple2<int, int>>(
                      ...
                      builder: (context, slidingMode, _) {
                        return BlocBuilder<HomeBloc, HomeState>(
                          ...
                          builder: (context, state) {
                            print('statusssss ${state
                                .getProductListingWithFiltersPaginationModels['women-section-67withoutFilter']?.paginationStatus}');
                                ...
                                slivers: [
                                                          ...
                                                          children: [
                                                            ...
                                                            BlocBuilder<
                                                              ...
                                                              buildWhen:
                                                                  (p, c) {
                                                                return (p
                                                                    .getProductListingWithFiltersPaginationModels['${widget
                                                                    .boutiqueSlug}' +
                                                                    '${state
                                                                        ...
                                                                        if (!isExpanded) {
                                                                          ...
                                                                          homeBloc
                                                                              ...
                                                                              AddPrefAppliedFilterForExtendFilterEvent(
                                                                                  prefAppliedFilter: prefAppliedFilters));
                                  ...
                                  isExpanded
                                    ...
                                    builder: (context, state) {
                                      ...
                                      print(
                                          ("//////////////////////////////////////////////////////////${state
                                              .getProductListingWithFiltersPaginationWithPrefetchModels["${widget
                                              .boutiqueSlug}" +
                                              "${currentAppliedFilterSllug}" +
                                              "${widget.category ?? ""}"]
                                              ?.paginationStatus}"));
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    child: ProductItem(
                                                      key: TestVariables
                                                          ...
                                                          ? Key(
                                                          '${WidgetsKey
                                                              .productInBoutiqueListKey}$index')
                                                          : null,
                                                      slidingModeItem:
                                                      slidingMode,
                                                      productItem:
                                  ...
                                  BlocBuilder<HomeBloc, HomeState>(
                                      builder: (context, state) {
                                        ...
                                        '${widget.boutiqueSlug}' +
                                            ...
                                            ?.paginationStatus ==
                                            PaginationStatus
                                                .loading  && state.isGettingProductListingWithPagination) {
                                          return SliverToBoxAdapter(
                                            child: Center(
                                              child: TrydosLoader(),
                                            ),
