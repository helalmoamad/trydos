                      ...
                      builder: (context, slidingMode, _) {
                        return BlocBuilder<HomeBloc, HomeState>(
                          ...
                          builder: (context, state) {
                            ...
                            print(
                                'statusssss ${state
                                    .getProductListingWithFiltersPaginationModels['women-section-67withoutFilter']
                                    ?.paginationStatus}');
                                                                        ...
                                                                        if (!isExpanded) {
                                                                          ...
                                                                          FirebaseAnalyticsService
                                                                            ...
                                                                            eventName: AnalyticsEventsConst
                                                                                .buttonClicked,
                                                                            executedEventName: AnalyticsExecutedEventNameConst
                                                                                .productListingFilterIconButton,
                                                                          );
                                                                          /////////////////////////////////////////
                                                                          FirebaseAnalyticsService
                                                                              .logScreen(
                                                                            screen: AnalyticsScreensConst
                                      ...
                                      '${widget.boutiqueSlug}' +
                                          ...
                                          '${widget.boutiqueSlug}' +
                                              ...
                                              '${widget.boutiqueSlug}' +
                                                  ...
                                                  .isNullOrEmpty)) {
                                        print(
                                            "11111111111111111111111111${state
                                                .getProductListingWithFiltersPaginationModels['${widget
                                                .boutiqueSlug}' +
                                                'withoutFilter' +
                                                '${(widget.category ?? '')}']
