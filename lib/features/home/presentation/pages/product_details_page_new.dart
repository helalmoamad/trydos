        ...
        ScrollConfiguration(
          ...
          child: ListView.separated(
            itemCount: productItem!.syncColorImages.isNullOrEmpty
                ...
                : !productItem.syncColorImages![currentSelectedColor].images
                        .isNullOrEmpty
                    ? productItem
                        .syncColorImages![currentSelectedColor].images!.length
                    : 0,
            primary: false,
            shrinkWrap: true,
            physics: const ClampingScrollPhysics(),
                ...
                builder: (context, _visibleVedio, _) {
                  return !_visibleVedio
                      ...
                      : Positioned(
                          bottom: 20,
                          right:
                              LanguageService.languageCode != "ar" ? 10 : null,
                          left:
                              LanguageService.languageCode != "ar" ? null : 10,
                          child: Container(
                            width: 140,
                            height: 200,
                            child: Stack(
                ...
                builder: (context, _visibleVedio, _) {
                  return !_visibleVedio
                      ...
                      : Positioned(
                          bottom: 207,
                          right:
                              LanguageService.languageCode != "ar" ? 132 : null,
                          left:
                              LanguageService.languageCode != "ar" ? null : 132,
                          child: InkWell(
