...
class DisplaySizesCard extends StatefulWidget {
  const DisplaySizesCard(
      {super.key, required this.scrollController, required this.sizes});

  final ScrollController scrollController;
  final List<ChoiceOption>? sizes;
              ...
              : LocalHeroScope(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: mode == 0 ? 20.0 : 0, right: mode == 0 ? 10 : 0),
                    child: AnimatedSize(
                                                  ...
                                                  : Material(
                                                      ...
                                                      child: Gallery3D(
                                                          ...
                                                          onClickItem: (index) {
                                                            ...
                                                            displayMode.value =
                                                                1;
                                                            if ((widget.scrollController.position
                                                                            .pixels -
                                                                        widget
                                                                            .scrollController
                                                                            .position
                                                          ...
                                                          itemBuilder:
                                                              (context, index) {
                                                            return Visibility(
                                                                visible: ((gallery3dControllerForCircles?.currentIndex ??
                                                                                0) <
                                                                            (sizes!.length ~/
                                                                                2) &&
                                                                        index <
