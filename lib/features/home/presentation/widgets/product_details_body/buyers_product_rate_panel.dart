...
class BuyersProductRatePanel extends StatelessWidget {
  const BuyersProductRatePanel(
      {super.key, required this.panelController, required this.productFirstId});
        ...
        panelBuilder: (scrollController) {
          return BlocBuilder<HomeBloc, HomeState>(
              ...
              builder: (context, state) {
                ...
                return BlocBuilder<HomeBloc, HomeState>(
                    buildWhen: (previous, current) =>
                        previous.getAndAddCountViewOfProductStatus[productId] !=
                        current.getAndAddCountViewOfProductStatus[productId],
                    builder: (context, state) {
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buyerReviewSingle(
                                LocaleKeys.small.tr(), 3, context),
                            const SizedBox(
                              height: 10,
                            ),
                            _buyerReviewSingle(
                                LocaleKeys.large.tr(), 1, context),
                            Container(
                              margin: const EdgeInsets.symmetric(vertical: 12),
                              decoration: BoxDecoration(
                                color: const Color(0xffD3D3D3),
  ...
  Widget _buyerReviewSingle(
      String text, int numOfPercent, BuildContext context) {
    return SizedBox(
      width: 1.sw,
      height: 20,
      child: Row(children: [
