                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: '25% Refund',
                                        style: context.textTheme.caption?.mq
                                            .copyWith(
                                          color: const Color(0xff8d8d8d),
                                          height: 14 / 11,
                                        ),
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          ...
                                          style: context.textTheme.caption?.lq
                                              .copyWith(
                                            color: const Color(0xff8d8d8d),
                                            height: 14 / 11,
                                          ),
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                ...
                                style: context.textTheme.caption?.lq.copyWith(
                                  color: const Color(0xff8d8d8d),
                                  height: 14 / 11,
                                ),
                              ),
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: '3 Days',
                                style: context.textTheme.caption?.mq.copyWith(
                                  color: const Color(0xff8d8d8d),
                                  height: 14 / 11,
                                ),
                              ),
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    ...
                                    style:
                                        context.textTheme.caption?.lq.copyWith(
                                      color: const Color(0xff8d8d8d),
                                      height: 14 / 11,
                                    ),
                                  ),
