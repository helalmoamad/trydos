  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HomeBloc, HomeState>(
      buildWhen: (previous, current) =>
          previous.getCartItemsStatus != current.getCartItemsStatus || previous.getOldCartItemsStatus!=current.getOldCartItemsStatus||
          previous.getCurrencyForCountryModel !=
              current.getCurrencyForCountryModel || previous.getOldCartItemsStatus!=current.getOldCartItemsStatus||
      ...
      builder: (context, state) {
        return ListView.builder(
          ...
          itemCount:isOLdCart? oldcartCollection!.length: cartCollection!.length,
          itemBuilder: (context, index) {
            ...
            }else{ cartCollection!.values.toList()[index].forEach((element) {
              price = price + element.offerPrice! * element.quantity!;
            });}
                        ...
                        Container(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                 isOLdCart?"  ${oldcartCollection!.values.toList()[index].length} ": "  ${cartCollection!.values.toList()[index].length} ",
                    ...
                    visibleCollectionGroups
                        ...
                        ? Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                               isOLdCart?oldcartCollection![groupCartkeys[index]]!.length:   cartCollection![groupCartkeys[index]]!.length,
                                                        ...
                                                        AppElevatedButton(
                                                          onPressed: () {
                                                            BlocProvider.of<HomeBloc>(context).add(UpdateItemInCartEvent(
                                                                maxAllowed:
                                                                    double.tryParse(
                                                                    isOLdCart? oldcartCollection![groupCartkeys[index]]![indexes].maxAllowedQty ??
                                                                            "0":    cartCollection![groupCartkeys[index]]![indexes].maxAllowedQty ??
                                                                            "0"),
                                                                countOfPieces:
                                                                  isOLdCart? oldcartCollection![groupCartkeys[index]]![indexes]
                                                                        .countOfPieces:  cartCollection![groupCartkeys[index]]![indexes]
                                                                        .countOfPieces,
                                                                image:isOLdCart?oldcartCollection![groupCartkeys[index]]![indexes]
                                                                        .image ??
                                                                    "": cartCollection![groupCartkeys[index]]![indexes]
                                                                        .image ??
                                                                    "",
                                                                currentSize:isOLdCart?!oldcartCollection![groupCartkeys[index]]![indexes]
                                                                        .variations
                                                                        .isNullOrEmpty
                                                                ...
                                                                cartId:isOLdCart?
                                                                 oldcartCollection![groupCartkeys[index]]![indexes].id.toString(): cartCollection![groupCartkeys[index]]![indexes].id.toString(),
                                                      ...
                                                      BlocProvider.of<HomeBloc>(context).add(RemoveItemFormCartEvent(
                                                          ...
                                                          !oldcartCollection![groupCartkeys[index]]![indexes]
                                                              ...
                                                              ? cartCollection![groupCartkeys[index]]![indexes].variations![0].size ??
                                                                  ""
                                                              : "",
                                                          ColoName:isOLdCart?!oldcartCollection![groupCartkeys[index]]![indexes]
                                                                  .variations
                                                                  .isNullOrEmpty
                                                              ? oldcartCollection![groupCartkeys[index]]![indexes].variations![0].color ??
                                                                  ""
                                                          ...
                                                          productId:
                                                            isOLdCart?
                                                             oldcartCollection![groupCartkeys[index]]![indexes]
                                                                  .productId
                                                                  .toString():  cartCollection![groupCartkeys[index]]![indexes]
                                                                  .productId
                                                                  .toString(),
                                                          itemId:isOLdCart?
                                                          oldcartCollection![groupCartkeys[index]]![indexes].id.toString(): cartCollection![groupCartkeys[index]]![indexes].id.toString(),
                                           ...
                                           isOLdCart?
                                            state.productITemForCart![
                                                  oldcartCollection![groupCartkeys[
                                                          index]]![indexes]
                                                      .productId
                                                      .toString()]!:   state.productITemForCart![
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        child: Container(
                                          ...
                                          child: Text(
                                          isOLdCart?
                                          "${oldcartCollection![groupCartkeys[index]]![indexes].quantity}":  "${cartCollection![groupCartkeys[index]]![indexes].quantity}",
                                            style: context
                                      ...
                                      Positioned(
                                        child: Container(
                                         ...
                                         isOLdCart?
                                            ...
                                            '''${(oldcartCollection![groupCartkeys[index]]![indexes].offerPrice! * oldcartCollection![groupCartkeys[index]]![indexes].quantity! * state.getCurrencyForCountryModel!.data!.currency!.exchangeRate!).toStringAsFixed(state.startingSetting?.decimalPointSetting ?? 2)} '''
                                            '''${priceSymbol ?? '\$'}''':   '''${!cartCollection![groupCartkeys[index]]![indexes].variations.isNullOrEmpty ? cartCollection![groupCartkeys[index]]![indexes].variations![0].size ?? "" : ""} \n '''
                    ...
                    visibleCollectionGroups
                        ...
                        ? Container(
                            ...
                            child: ListView.builder(
                                ...
                                padding: EdgeInsets.only(top: 0),
                                itemCount:
                                isOLdCart?  oldcartCollection![groupCartkeys[index]]!
                                        .length:    cartCollection![groupCartkeys[index]]!
                                        .length,
                                    ...
                                    children: [
                                                            ...
                                                            children: [
                                                              AppElevatedButton(
                                                                onPressed: () {
                                                                  BlocProvider.of<HomeBloc>(context).add(UpdateItemInCartEvent(
                                                                      maxAllowed:
                                                                      isOLdCart?   double.tryParse(oldcartCollection![groupCartkeys[index]]![indexes].maxAllowedQty ??
                                                                              "0"):    double.tryParse(cartCollection![groupCartkeys[index]]![indexes].maxAllowedQty ??
                                                                              "0"),
                                                                      countOfPieces:isOLdCart?
                                                                       oldcartCollection![groupCartkeys[index]]![indexs]
                                                                          .countOfPieces: cartCollection![groupCartkeys[index]]![indexs]
                                                                          .countOfPieces,
                                                                      image:isOLdCart?
                                                                       oldcartCollection![groupCartkeys[index]]![indexes].image ??
                                                                          "": cartCollection![groupCartkeys[index]]![indexes].image ??
                                                                          "",
                                                                      currentSize:isOLdCart?!oldcartCollection![groupCartkeys[index]]![indexs].variations.isNullOrEmpty
                                                                          ? oldcartCollection![groupCartkeys[index]]![indexs].variations![0].size ??
                                                                              ""
                                                                          : "": !cartCollection![groupCartkeys[index]]![indexs].variations.isNullOrEmpty
                                                                          ? cartCollection![groupCartkeys[index]]![indexs].variations![0].size ??
                                                                              ""
                                                                          : "",
                                                                      colorName:isOLdCart?
                                                                      !oldcartCollection![groupCartkeys[index]]![indexs].variations.isNullOrEmpty
                                                                      ...
                                                                      productId:isOLdCart?
                                                                       oldcartCollection![groupCartkeys[index]]![indexs]
                                                                          .productId
                                                                          .toString(): cartCollection![groupCartkeys[index]]![indexs]
                                                                          .productId
                                                                          .toString(),
                                                                      quantity:
                                                                          int.tryParse(quantityController.text)!,
                                                                      cartId:isOLdCart? oldcartCollection![groupCartkeys[index]]![indexs].id.toString(): cartCollection![groupCartkeys[index]]![indexs].id.toString(),
                                                                      boutiqueId:isOLdCart?oldcartCollection![groupCartkeys[index]]![indexs].boutique!.id.toString(): cartCollection![groupCartkeys[index]]![indexs].boutique!.id.toString()));
                                                                  Navigator.pop(
                                                                      context);
                                                                },
                                                                text: "Yes",
                                            ...
                                            BlocProvider.of<HomeBloc>(context)
                                                .add(AddCurrentSelectedColorEvent(
                                                    currentSelectedColor:
                                                        indexess,
                                                    productId:isOLdCart? oldcartCollection![
                                                            groupCartkeys[
                                                                index]]![indexs]
                                                        .productId
                                                        .toString(): cartCollection![
                                              ...
                                              decoration: BoxDecoration(
                                                  ...
                                                  borderRadius:
                                                      BorderRadiusDirectional
                                                          .circular(20)),
                                              child: Text(
                                               isOLdCart?"${oldcartCollection![groupCartkeys[index]]![indexs].quantity}": "${cartCollection![groupCartkeys[index]]![indexs].quantity}",
                                                style: context
                                                    .textTheme.bodyMedium?.ra
                                                    .copyWith(
                                                  decorationColor:
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          ...
                                          isOLdCart? '''${!oldcartCollection![groupCartkeys[index]]![indexs].variations.isNullOrEmpty ? oldcartCollection![groupCartkeys[index]]![indexs].variations![0].size ?? "" : ""} \n '''
                                          '''${(oldcartCollection![groupCartkeys[index]]![indexs].offerPrice! * oldcartCollection![groupCartkeys[index]]![indexs].quantity! * state.getCurrencyForCountryModel!.data!.currency!.exchangeRate!).toStringAsFixed(state.startingSetting?.decimalPointSetting ?? 2)} '''
                                          '''${priceSymbol ?? '\$'}''':
