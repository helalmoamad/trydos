...
class _AddShippingAdressState extends State<AddShippingAdress>
  ...
  MapController mapController = MapController(
    ...
    initPosition: GeoPoint(latitude: 35, longitude: 36),
  );
  MapController fullMapController = MapController.withUserPosition(
      trackUserLocation:
          UserTrackingOption(enableTracking: true, unFollowUser: false));

  GeoPoint? preLocation;
  ...
  void initState() {
    ...
    fullMapController.listenerMapSingleTapping.addListener(() {
      if (fullMapController.listenerMapSingleTapping.value != null) {
        /*if (!removeMyLocation) {
          ...
          removeMyLocation = true;
        }*/

        if (preLocation?.latitude != null) {
          fullMapController.removeMarker(preLocation!);
        }
        fullMapController.addMarker(
            GeoPoint(
                latitude:
                    fullMapController.listenerMapSingleTapping.value!.latitude,
                longitude: fullMapController
        ...
        preLocation = GeoPoint(
            latitude:
                fullMapController.listenerMapSingleTapping.value!.latitude,
            longitude:
                fullMapController.listenerMapSingleTapping.value!.longitude);
      }
    });
                                  ...
                                  InkWell(
                                    ...
                                    child: Container(
                                        ...
                                        child: Transform.rotate(
                                          angle: LanguageService.languageCode ==
                                                  "ar"
                                              ? pi
                                              : 0,
                                                    ...
                                                    builder:
                                                        (context, child) =>
                                                            Transform.translate(
                                                              offset: Offset(
                                                                  !(isValidateBox &&
                                                                          ((preLocation?.latitude ?? 0) == 0 ||
                                                                              (preLocation?.longitude ?? 0) ==
                                                                                  0))
                                                                      ? 0
                                                                      : sin(3 *
                                                                              2 *
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      borderRadius:
                                                                          BorderRadius.circular(
                                                                              15),
                                                                      border: Border.all(
                                                                          color: isValidateBox && ((preLocation?.latitude ?? 0) == 0 || (preLocation?.longitude ?? 0) == 0)
                                                                              ? Colors.red
                                                                              : Color(0xffD3D3D3))),
                                                                  height: 118.h,
                                                                  child: Column(
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            margin:
                                                                                EdgeInsets.all(10.w),
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(15), border: Border.all(color: Color(0xffD3D3D3))),
                                                                            child:
                                                                                IgnorePointer(
                                                                              ignoring: true,
                                                                              child: OSMFlutter(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder: (context,
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          width: 1.sw,
                                                                          height: 53.h,
                                                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(15), border: Border.all(color: (isValidateBox && (finishSelectedByUser.length < 4)) ? Colors.red : Color(0xffD3D3D3))),
                                                                          child: Padding(
                                                                            padding:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  finishSelectedByUser.length == 4 ? LocaleKeys.change_from_list.tr() : LocaleKeys.select_from_list.tr(),
                                                                                  ...
                                                                                  child: Row(
                                                                                    children: [
                                                                                      SvgPicture.asset(
                                                                                        ...
                                                                                        color: finishSelectedByUser.length == 4 ? Color(0xff1D1D1D) : Color(0xffD3D3D3),
                                                                                        height: 16,
                                                                                      ),
                                                                                      SizedBox(
                                                                                        width: 5.w,
                                                                                      ...
                                                                                      finishSelectedByUser.length == 4
                                                                                          ? Text(
                                                                                              "${finishSelectedByUser[0]},${finishSelectedByUser[1]},${finishSelectedByUser[2]},${finishSelectedByUser[3]}",
                                                          ...
                                                          if (!(widget
                                                            ...
                                                            homeBloc.add(
                                                              ...
                                                              location: address.Location(
                                                                  latitude: preLocation
                                                                          ?.latitude
                                                                          .toString() ??
                                                                      "",
                                                                  longitude: preLocation
                                                                          ?.longitude
                                                                          .toString() ??
                                                                      ""),
                                                                    ...
                                                                    addressInfoClassToSave:
                                                                      ...
                                                                      address:
                                                                          addressTitleController
                                                                              .text,
                                                                      location: address.Location(
                                                                          latitude: preLocation?.latitude.toString() ??
                                                                              "",
                                                                          longitude:
                                                                              preLocation?.longitude.toString() ?? ""),
                                                                      regionDetails:
                                                                          address
                                                                              .RegionDetails(
                                                                        building:
                                      ...
                                      state.resultSearch?.forEach(
                                        (element) {
                                          filterResultSearch.add(
                                              "${element.province ?? ""} | ${element.city ?? ""} | ${element.town ?? ""} | ${element.street ?? ""}");
                                        },
                                      );
                                                              ...
                                                              children: [
                                                                ...
                                                                addressTilteSeletedByUser
                                                                    ...
                                                                    ? Text(
                                                                        ...
                                                                        style: context.textTheme.bodyMedium?.mr.copyWith(
                                                                            color: addressTilteSeletedByUser.length == 1
                                                                                ? const Color(0xff1D1D1D)
                                                                                : const Color(0xffD3D3D3),
                                                                            letterSpacing: 0.18,
                                                                            fontSize: 14,
                                                                ...
                                                                addressTilteSeletedByUser
                                                                    ...
                                                                    ? Text(
                                                                        " | ${LocaleKeys.town.tr()}",
                                                                        style: context.textTheme.bodyMedium?.mr.copyWith(
                                                                            color: addressTilteSeletedByUser.length == 2
                                                                                ? const Color(0xff1D1D1D)
                                                                                : const Color(0xffD3D3D3),
                                                                            letterSpacing: 0.18,
                                                                            fontSize: 14,
                                                                ...
                                                                addressTilteSeletedByUser
                                                                    ...
                                                                    ? Text(
                                                                        ...
                                                                        style: context.textTheme.bodyMedium?.mr.copyWith(
                                                                            color: addressTilteSeletedByUser.length == 3
                                                                                ? const Color(0xff1D1D1D)
                                                                                : const Color(0xffD3D3D3),
                                                                            letterSpacing: 0.18,
                                                                            fontSize: 14,
                                                                              ...
                                                                              onTap: () {
                                                                                if ((searchController.text.length) > 0) {
                                                                                  listOfAddressTilteSeletedByUser.value = [
                                                                                    filterResultSearch[index].split(" | ").toList()[0],
                                                                                    filterResultSearch[index].split(" | ").toList()[1],
                                                                                    filterResultSearch[index].split(" | ").toList()[2],
                                                                                    filterResultSearch[index].split(" | ").toList()[3]
                                                                                  ];
                                                                                } else {
                                                                                  listOfAddressTilteSeletedByUser.value = [
                                                                                    ...addressTilteSeletedByUser,
