    ...
    return BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
      ...
      if (lowerAndUpperBound == null && filters.prices != null) {
        ...
        maxPrice = filters.prices!.maxPrice! *
            state.getCurrencyForCountryModel!.data!.currency!.exchangeRate!;
        lowerAndUpperBound = ValueNotifier(Tuple2(
                              ...
                              builder: (BuildContext context, bool isInView,
                                ...
                                if (isInView &&
                                  ...
                                  WidgetsBinding.instance
                                    ...
                                    widget.onMoveToAnotherFiltersSection
                                        .call(titleOfFilterSection[index ~/ 2]);
                                  });
                                }
                                return child!;
                              },
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        MyTextWidget(
                          '${filters.prices != null ? filters.prices!.currencySymbol.toString() : currencySymbol}' +
                              ' ',
                          maxLines: 1,
                          textAlign: TextAlign.center,
                          style: context.textTheme.caption?.rq.copyWith(
                        ...
                        MyTextWidget(
                          '${filters.prices != null ? (filters.prices!.minPrice! * state.getCurrencyForCountryModel!.data!.currency!.exchangeRate!).toString() : lowerAndUpperBound!.value.item1}' +
                              '/',
                          maxLines: 1,
                          textAlign: TextAlign.center,
                          style: context.textTheme.caption?.rq.copyWith(
                        ...
                        MyTextWidget(
                          '${filters.prices != null ? (filters.prices!.maxPrice! * state.getCurrencyForCountryModel!.data!.currency!.exchangeRate!).toString() : lowerAndUpperBound!.value.item2}',
                          maxLines: 1,
                          textAlign: TextAlign.center,
                          style: context.textTheme.caption?.rq.copyWith(
                              color: Color(0xff8E8E8E),
