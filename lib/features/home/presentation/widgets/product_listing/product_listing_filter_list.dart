          ...
          return Column(
            ...
            children: [
                                                                      ...
                                                                      addOrRemoveSpecificFilter:
                                                                        ...
                                                                        if (add) {
                                                                          ...
                                                                          widget
                                                                              .listKey
                                                                              .currentState!
                                                                              .insertItem(selectedFilters.length - 1);
                                                                          widget
                                                                            ...
                                                                            final Tuple3<int, int?, double>
                                                                                item =
                                                                                Tuple3(15 * index + innerIndex + 1, 15 * index, 10);
                                                                            ...
                                                                            widget.listKey.currentState!.removeItem(
                                                                              removedIndex,
                                                                              (context, animation) => buildItem(removedIndex, item, animation),
                                                                            );
                                                                ...
                                                                return FilterCircleWidget(
                                                                    ...
                                                                    addOrRemoveSpecificFilter:
                                                                      ...
                                                                      if (add) {
                                                                        ...
                                                                        expandingFiltersStack.value =
                                                                            -1;
                                                                        final List<Tuple3<int, int?, double>>
                                                                            itemToRemove =
                                                                            [];
              ...
              if (!widget.isExpanded) ...{
                Container(
                  padding:
                      EdgeInsets.only(top: selectedFilters.isNotEmpty ? 5 : 0),
              ...
              if (widget.isExpanded) ...{
                ...
                Column(
                  children: [
                    Container(
                      width: 1.sw,
                      height: selectedFilters.isNotEmpty ? 55 : 0,
                      margin: EdgeInsets.symmetric(horizontal: 10),
                      decoration: BoxDecoration(
