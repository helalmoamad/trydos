    ...
    return BlocBuilder<HomeBloc, HomeState>(
      builder: (context, state) {
        ...
        return InkWell(
          onTap: () {
            print(
                'categories length : ${filters.categories == null ? null : filters.categories!.length}');

            String boutiqueSlugInFilterData = filters.boutiques?[0].slug ?? '';

            print(
                '////// boutiques length : ${filters.boutiques?.length} /////////////////');
            ...
            child: ListView.builder(
              ...
              itemBuilder: (ctx, index) {
                ...
                if (!(filters.categories![index].subCategories?.isNullOrEmpty ??
                  ...
                  return filters
                              .categories![index].mostViewedProductThumbnail !=
                          null
                      ? FilterCircleWidget(
                          isSvg: false,
                          width: 65,
