...
@injectable
class GetProductsWithoutFiltersUseCase implements UseCase< GetProductListingWithoutFiltersModel, GetProductsWithoutFiltersParams> {
...
class GetProductsWithoutFiltersParams{
  ...
  final int? offset;
  final int? limit;
  GetProductsWithoutFiltersParams({this.prices, this.brands, this.attributes, this.searchText, this.offset, this.limit, this.category});
