...
import 'dart:convert';
  ...
  GetCountLikesOFProductModel getHomeBoutiquesModelFromJson(String str) =>
      GetCountLikesOFProductModel.fromJson(json.decode(str));

String getHomeBoutiquesModelToJson(  GetCountLikesOFProductModel data) =>
    json.encode(data.toJson());

class   GetCountLikesOFProductModel {
  final String? message;
  final Data? data;

   GetCountLikesOFProductModel({
    this.message,
    this.data,
  });

   GetCountLikesOFProductModel copyWith({
    String? message,
    Data? data,
  }) =>
       GetCountLikesOFProductModel(
  ...
  factory   GetCountLikesOFProductModel.fromJson(Map<String, dynamic> json) =>
       GetCountLikesOFProductModel(
