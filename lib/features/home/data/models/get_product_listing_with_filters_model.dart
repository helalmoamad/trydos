  ...
  factory DataGetProductListingWithFiltersModel.fromJson(
    ...
    return DataGetProductListingWithFiltersModel(
      ...
      offset: json["offset"] == null
          ? []
          : List<double>.from(json["offset"]!.map((x) => x?.toDouble())),
      products: json["products"] == null
          ? []
          : List<product_without_filters.Products>.from(
              json["products"]!.map(
                (x) => product_without_filters.Products.fromJson(x),
              ),
            ),
...
class Color {
  ...
  Color({this.name, this.color});

  Color copyWith({String? name, String? color}) =>
      Color(name: name ?? this.name, color: color ?? this.color);

  factory Color.fromJson(Map<String, dynamic> json) =>
      Color(name: json["name"], color: json["color"]);
...
class SyncColorImage {
  ...
  SyncColorImage({this.colorName, this.images, this.colorTrend});
...
class Category {
  ...
  final CategoryBanner? flatPhotoPath;

  final bool isSubCategory;
  final bool isSelected;
  CategoryBanner? mostViewedProductThumbnail;
