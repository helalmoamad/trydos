...
@injectable
class UpdateVendorRequestUseCase
    extends UseCase<ReadOnlyMessageFromApiModel, UpdateVendorRequestParams> {
  final DashBoardRepository repository;

  UpdateVendorRequestUseCase(this.repository);

  @override
  Future<Either<Failure, ReadOnlyMessageFromApiModel>> call(
    UpdateVendorRequestParams params,
  ) {
    return repository.updateVendorRequest(
...
class UpdateVendorRequestParams {
