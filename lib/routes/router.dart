...
import 'package:trydos/features/authentication/presentation/pages/verification_page.dart';
              ...
              pageBuilder: (BuildContext context, GoRouterState state) {
                ...
                return _builderPage(
                  child: SinglePageChat(
                    ...
                    receiverPhoto: state.uri.queryParameters['receiverPhoto'] == 'null' ? null : state.uri.queryParameters['receiverPhoto'],
                    senderPhoto: state.uri.queryParameters['senderPhoto'] == 'null' ? null : state.uri.queryParameters['senderPhoto'],
                  ),
                  state: state,
                );
              },
