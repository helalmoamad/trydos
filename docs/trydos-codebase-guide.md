# Trydos codebase guide

Architecture, commands, and conventions for this repository — for Claude Code
(claude.ai/code) and for humans. It describes **the code**. The engineering
**workflow** that governs how changes are made lives in the root `CLAUDE.md`
and in the `wf` plugin.
